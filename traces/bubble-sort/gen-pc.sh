...
sigrok-cli -i first_complete_trace.sr -P uart:baudrate=16000000:rx=D7,arm_tpiu:stream=10:sync_offset=7,arm_etmv3:branch_enc=original -S uart,arm_tpiu,arm_etmv3 -A arm_etmv3=pc > pc
